...
public class DecisionTree {
    ...
    public void writeDecisionTreeToFile(TreeNode node, String indent, PrintWriter writer) {
        writer.println(indent + node.attribute + " ?");
        for (String value : node.children.keySet()) {
            writer.println(indent + "|-- " + value);
            writeDecisionTreeToFile(node.children.get(value), indent + "   ", writer);
        }
    }
